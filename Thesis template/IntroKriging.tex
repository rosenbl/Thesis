...
where $\mathbf{s} = (s_1, s_2)$ are latitude and longitude. This restricts the mean to independent latitude and longitude effects, which can be circumvented by using higher order models such as the quadratic:
